...
//        SimpleMatrixOperations.getRowArray(mVecArray, nodeIdx, nTraits, mVec);
//        return mVec;
//    }
//
...
//        SimpleMatrixOperations.setArray(mVecArray, value, nodeIdx, nTraits);
//    }
//
...
//        SimpleMatrixOperations.getRowArray(traitValues, tipIdx, nTraits, traitsVec);
//    }
//
//    public void setTraitsVecForSampledAncestor (double[] traitValues, int nodeIdx) {
//        SimpleMatrixOperations.getRowArray(traitValues, nodeIdx, nTraits, traitVecForSA);
//    }
//
//    public void setExpectationForTip (int nodeIdx) {
//        SimpleMatrixOperations.setArray(nodeExpectation, traitsVec, nodeIdx, nTraits);
//    }
//
...
//        double vc1 = nodeVariance[child1Idx];
//        double vc2 = nodeVariance[child2Idx];
//        SimpleMatrixOperations.getRowArray(nodeExpectation, child1Idx, nTraits, expect1);
//        SimpleMatrixOperations.getRowArray(nodeExpectation, child2Idx, nTraits, expect2);
//        SimpleMatrixOperations.arrayMapmultiply(expect1, vc2/(vc1+vc2), expect1);
//        SimpleMatrixOperations.arrayMapmultiply(expect2, vc1/(vc1+vc2), expect2);
//        SimpleMatrixOperations.vectorAdd(expect1, expect2, expectp);
//        SimpleMatrixOperations.setArray(nodeExpectation, expectp, parentIdx, nTraits);
//    }
//
...
//            SimpleMatrixOperations.setArrayEntry(identityMatrix, i, i, 1.0, nTraits);
//        }
//    }
//
//
...
//        }
//        if(!sampleRoot) {
//            SimpleMatrixOperations.getRowArray(nodeExpectation, rootIdx, nTraits, rootValuesVec);
//        }
//    }
//
//    /*
