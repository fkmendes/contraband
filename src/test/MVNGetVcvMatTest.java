...
public class MVNGetVcvMatTest {
	
	final static double EPSILON = 1e-4;
	private double[][] tMat, tMat2;
	...
	@Test // Test1
	public void againstUltVcvMat() {
		
		Assert.assertEquals(10.81957, tMat[7][5], EPSILON); 
		Assert.assertEquals(19.93735, tMat[24][26], EPSILON);
		Assert.assertEquals(20.45626, tMat[24][24], EPSILON);
		Assert.assertEquals(20.45626, tMat[26][26], EPSILON);
	}
	
	@Test // Test2
	public void againstNonUltVcvMat() {
		
		Assert.assertEquals(10.81957, tMat2[7][5], EPSILON); 
		Assert.assertEquals(10.39529, tMat2[24][26], EPSILON);
		Assert.assertEquals(11.19529, tMat2[24][24], EPSILON);
		Assert.assertEquals(10.79529, tMat2[26][26], EPSILON);
	}
