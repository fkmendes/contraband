...
public class BMPruneLikelihoodWithMissingData {
    ...
    /*
     * (1) there are 10 species in total, 4 of them have missing data, including t2, t4, t5, t8
     *     three continuous traits for the rest of the 6 species
     *     the trait correlations are specified, root values are estimated by MLE
     */
    @Test
    public void testBMPruneLikelihoodWithMissingData() {
        // tree
        ...
        // this the MLE of root values. can be either specified or not.
        //rootValues = new RealParameter(new Double[] {1.88992288820042, -2.81680659985333, -5.39528907654654});
        nodeMath.initByName("traits", traitValues, "sigmasq", sigmasq, "correlation", correlation, "tree", tree);
    ...
    /*
     * (2) To verify the likelihood in test (1)
     *     after pruning the species without trait values, there are 6 six left, all of which have continuous data
     */
    @Test
    public void testBMPruneLikelihoodWithoutMissingData() {
        // tree
        treeStr = "((t6:8.010964925,t3:8.010964925):4.138629419,(((t9:1.420145405,t10:1.420145405):2.024407676,t7:3.444553081):7.252722915,t1:10.697276):1.452318347);";
        tree = new TreeParser(treeStr, false, false, true, 0);
    ...
    /*
     * (3) there are 8 species in the tree, 2 of them don't have continuous data
     *     the rest of the 6 species have 5 continuous trait values
     *     the trait correlations are estimated by shrinkage estimate method
     *     the root values are estimated by MLE
     */
    @Test
    public void testBMPruneShrinkageLikelihoodWithMissingData() {
        // tree
    ...
    /*
     * (4) To verify the likelihood in test (3)
     */
    @Test
    public void testBMPruneShrinkageLikelihoodWithoutMissingData() {
        // tree
