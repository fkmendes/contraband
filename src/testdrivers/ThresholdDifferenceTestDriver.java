...
import contraband.prunelikelihood.ThresholdDifference;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class ThresholdDifferenceTestDriver {
    public static void main(String[] args) {
        ...
        ThresholdDifference thresholdDifference = new ThresholdDifference();
        thresholdDifference.initByName("trait", orderedDiscreteTraits);

        double[] diff = thresholdDifference.getDoubleValues();
