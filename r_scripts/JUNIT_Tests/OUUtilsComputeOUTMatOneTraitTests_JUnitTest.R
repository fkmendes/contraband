...
ouCovFI <- as.numeric(fitFI$sigma) * varOU(tr, as.numeric(fitFI$alpha), T)
ouCovFM <- as.numeric(fitFM$sigma) * varOU(tr, as.numeric(fitFM$alpha), T)
ouCovRI <- as.numeric(fitRI$sigma) * varOU(tr, as.numeric(fitRI$alpha), F)
ouCovRM <- as.numeric(fitRM$sigma) * varOU(tr, as.numeric(fitRM$alpha), F)

##### Hardcoded expected results (not an output of mvOU, just printed here)
...
##### Values to compare with Java classes
###### Pau's functions output
ouCovFI <- as.numeric(fitFI$sigma) * varOU(tr2, as.numeric(fitFI$alpha), T)
ouCovFM <- as.numeric(fitFM$sigma) * varOU(tr2, as.numeric(fitFM$alpha), T)
ouCovRI <- as.numeric(fitRI$sigma) * varOU(tr2, as.numeric(fitRI$alpha), F)
ouCovRM <- as.numeric(fitRM$sigma) * varOU(tr2, as.numeric(fitRM$alpha), F)
...
#### Values to compare with Java classes
##### Pau's functions output
ouCovFI <- as.numeric(fitFI$sigma) * varOU(tr3, as.numeric(fitFI$alpha), T)
ouCovFM <- as.numeric(fitFM$sigma) * varOU(tr3, as.numeric(fitFM$alpha), T)
ouCovRI <- as.numeric(fitRI$sigma) * varOU(tr3, as.numeric(fitRI$alpha), T)
ouCovRM <- as.numeric(fitRM$sigma) * varOU(tr3, as.numeric(fitRM$alpha), T)
