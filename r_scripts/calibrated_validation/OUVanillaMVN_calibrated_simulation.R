...
xmlfolder.path <- "/home/fkur465/Documents/uoa/contraband/r_scripts/calibrated_validation/OUVanillaMVNOneTrait_nonultra_xmls/"
shell.scripts.path <- "/home/fkur465/Documents/uoa/contraband/r_scripts/calibrated_validation/OUVanillaMVNOneTrait_nonultra_shellscripts/"
rdata.path <- gsub("_template.xml", ".RData", template.path)
...
## for non-ultrametric analysis (comment out or in w.r.t. to lines above)
xml.file.path <- "/nesi/project/nesi00390/fkmendes/contraband/calibrated_validation/OUVanillaMVNOneTrait_nonultra_xmls/"
xml.file.prefix <- "OUVanillaMVNLikelihoodOneTrait_fixedtree_nonultra_"
res.path <- "/nesi/project/nesi00390/fkmendes/contraband/calibrated_validation/OUVanillaMVNOneTrait_nonultra_results/"
jar.path <- "/nesi/project/nesi00390/fkmendes/contraband/contraband.jar"
time.needed <- "01:00:00"
