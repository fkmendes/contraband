...
xml.file.path <- paste0(cluster.validation.folder, "BMMVNShiftOneRateOneTrait_", tree.type, "_xmls/")
res.path <- paste0(cluster.validation.folder, "BMMVNShiftOneRateOneTrait_", tree.type, "_results/")
jar.path <- args[13]
