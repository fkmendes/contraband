...
## longest.40.branches <- tr$edge.length %in% tail(sort(tr$edge.length), n=40)
## tr$edge.length[longest.40.branches] = tr$edge.length[longest.40.branches] * .05
## tr$edge.length[longest.40.branches] = 0.1
